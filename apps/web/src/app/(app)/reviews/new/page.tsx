...
import { Brain, CirclePlay, Coins, Cpu, PlayCircle, Timer, Zap } from "lucide-react";

type Model = "haiku" | "sonnet" | "opus" | "auto";

function isModel(v: string | null): v is Model {
    ...
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:items-start">
      ...
      <div className="rounded-xl border border-border bg-card/60 p-6 backdrop-blur-sm">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-5">
          ...
          <Button
            type="submit"
            disabled={isStreaming || diff.trim().length === 0}
            className="w-full bg-gradient-to-r from-indigo-500 to-violet-600 text-white shadow-lg shadow-primary/20 hover:brightness-110 disabled:opacity-50"
          >
            {isStreaming ? (
